...
- ST_SYS_BARRIER: ticket imperso y barrera subida
...
| ST_SYS_PROCESS | EV_SYS_COIL_NOT_DETECT       | -               | ST_SYS_IDLE     | raise EV_ACT_BARRIER_DOWN; raise EV_ACT_SERVER_SEND; raise EV_ACT_DISPLAY_OFF |
